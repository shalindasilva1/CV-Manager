...
export interface IClient {
     ...
     * @return Success
     */
    skillsAll(): Observable<Skills[]>;
    /**
     * @param body (optional) 
     * @return Success
     */
    skillsPOST(body: Skills | undefined): Observable<Skills>;
    /**
     * @return Success
     */
    skillsGET(id: number): Observable<Skills>;
    /**
     * @param body (optional) 
     * @return Success
     */
    skillsPUT(id: number, body: Skills | undefined): Observable<void>;
    /**
     * @return Success
     */
    skillsDELETE(id: number): Observable<void>;
}
...
export class Client implements IClient {
    ...
    skillsAll(): Observable<Skills[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSkillsAll(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSkillsAll(<any>response_);
                } catch (e) {
                    return <Observable<Skills[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<Skills[]>><any>_observableThrow(response_);
        }));
    }

    protected processSkillsAll(response: HttpResponseBase): Observable<Skills[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(Skills.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
        ...
        return _observableOf<Skills[]>(<any>null);
    }
    ...
    skillsPOST(body: Skills | undefined): Observable<Skills> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSkillsPOST(<any>response_);
                } catch (e) {
                    return <Observable<Skills>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSkillsPOST(response: HttpResponseBase): Observable<Skills> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = Skills.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    skillsGET(id: number): Observable<Skills> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSkillsGET(<any>response_);
                } catch (e) {
                    return <Observable<Skills>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSkillsGET(response: HttpResponseBase): Observable<Skills> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    skillsPUT(id: number, body: Skills | undefined): Observable<void> {
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSkillsPUT(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSkillsPUT(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    skillsDELETE(id: number): Observable<void> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSkillsDELETE(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSkillsDELETE(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSkillsDELETE(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
